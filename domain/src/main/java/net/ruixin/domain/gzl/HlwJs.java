...
@Table(name = "T_GZL_HLW_JS")
@Entity
@DynamicInsert
@DynamicUpdate
public class HlwJs extends BaseDomain{
      
    /**
     * 主键
     */
    @Id
    @SequenceGenerator(name = "seq_t_gzl_hlw_js", sequenceName = "SEQ_T_GZL_HLW_JS", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_t_gzl_hlw_js")
    private Long id;
        /**
     * 信息发布ID
     */
