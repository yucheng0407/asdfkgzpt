...
public class RuleService implements IRuleService {
    ...
    private static final String DEFAULT_RULE_DETAIL = "PKG_WF_DAMIC_USER.P_WF_DEFAULT_TRANSACTOR";
    ...
    public void saveAuthRule(SysAuthRule sysAuthRule) {
        SysBaseRule baseRule = sysAuthRule.getSysBaseRule();
        if (baseRule != null) {
            if ("0".equals(baseRule.getConfigType())) {
                baseRule.setRule_detail(DEFAULT_RULE_DETAIL);
            }
        }
